# Django Apartment Management System (beta)
This is a Simple Apartment Management System Developed for Renting and Buying Purpose using Python (Django).
